...
import type { TStartupConfig } from 'tezgpt-data-provider';
...
/** Label of the `softDefault: true` spec in e2e/config/tezgpt.e2e.yaml. */
const SOFT_DEFAULT_LABEL = 'E2E Soft Default';

/** Name (URL identity) of the `softDefault: true` spec in e2e/config/tezgpt.e2e.yaml. */
const SOFT_DEFAULT_NAME = 'e2e-soft-default';

/** Ephemeral endpoint from e2e/config/tezgpt.e2e.yaml with no mirroring spec. */
