/**
 * In-process fake LLM for credential-free e2e tests. Loaded by `@tezgpt/api`'s
 * `createRun` via the `TEZGPT_TEST_RUN_HOOK` env var (set by the mock
...
const SKILL_DESCRIPTION =
  'Use this skill to verify TezGPT skill file authoring in mock end-to-end tests.';
const EDITED_SKILL_DESCRIPTION =
  'Use this edited skill to verify TezGPT skill file authoring in mock end-to-end tests.';
...
/** @type {import('@tezgpt/api').TestRunHook} */
