# TezGPT Localization Guide

This guide explains how to add new languages to TezGPT's localization system.

## Adding a New Language

To add a new language to TezGPT, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [TezGPT locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through TezGPT's automated translation platform
