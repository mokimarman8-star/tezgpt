...
import { Constants, splitMCPToolKey, buildServerNameAliases } from 'tezgpt-data-provider';
import type { TPlugin } from 'tezgpt-data-provider';
 ...
 * Separates regular TezGPT tools from MCP servers.
 *
 * @param selectedToolIds - Array of selected tool IDs
 * @param regularTools - Array of regular TezGPT tools
