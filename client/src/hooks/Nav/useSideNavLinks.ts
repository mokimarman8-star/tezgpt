...
import { MCPIcon, AttachmentIcon, OpenAIMinimalIcon } from '@tezgpt/client';
import {
  Bot,
  Brain,
  Bookmark,
...
import type { TInterfaceConfig, TEndpointsConfig } from 'tezgpt-data-provider';
...
export default function useSideNavLinks({
  ...
  const Links = useMemo(() => {
    ...
    // TezGPT Agent Mode — always available (BYOK)
    links.push({
      title: 'com_nav_agent_mode',
      label: '',
      icon: Bot,
