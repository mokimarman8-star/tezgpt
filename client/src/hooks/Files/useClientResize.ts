...
import { mergeFileConfig } from 'tezgpt-data-provider';
import type { FileConfig } from 'tezgpt-data-provider';
 ...
 * `clientImageResize.enabled` is set in `tezgpt.yaml` it is reported as
