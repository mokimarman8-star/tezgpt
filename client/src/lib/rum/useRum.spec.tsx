...
describe('useRum', () => {
    ...
    mockUseGetStartupConfig.mockReturnValue({
      data: {
        rum: {
          ...
          serviceName: 'tezgpt-web',
          authMode: 'publicToken',
          publicToken: 'public-token',
          tracePropagationTargets: ['https://tezgpt.example.com'],
        },
      },
    });
  ...
  it('initializes proxy RUM with the TezGPT bearer token for same-origin ingest', async () => {
