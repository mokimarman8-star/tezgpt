...
import { Permissions, SystemRoles } from 'tezgpt-data-provider';
import {
  Label,
  Button,
  Switch,
...
import type { PermissionTypes } from 'tezgpt-data-provider';
                      ...
                      {showAdminWarning &&
                        ...
                        permission === Permissions.USE && (
                          <div className="whitespace-normal break-words border-t border-border-light px-4 py-3 text-sm text-text-destructive">
                            ...
                            <a
                              href="https://www.tezgpt.app/docs/configuration/tezgpt_yaml/object_structure/interface"
                              target="_blank"
                              rel="noreferrer"
