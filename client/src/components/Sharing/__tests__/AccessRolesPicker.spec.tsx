...
import { AccessRoleIds } from 'tezgpt-data-provider';
import { OGDialog, OGDialogContent } from '@tezgpt/client';
...
jest.mock('tezgpt-data-provider/react-query', () => ({
  useGetAccessRolesQuery: () => {
    const { AccessRoleIds: roleIds } = jest.requireActual('tezgpt-data-provider');
    return {
