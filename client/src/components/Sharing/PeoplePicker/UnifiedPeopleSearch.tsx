...
import { useSearchPrincipalsQuery } from 'tezgpt-data-provider/react-query';
import type { TPrincipal, PrincipalType, PrincipalSearchParams } from 'tezgpt-data-provider';
