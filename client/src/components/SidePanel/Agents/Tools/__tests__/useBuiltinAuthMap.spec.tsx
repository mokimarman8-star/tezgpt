...
import { AuthType, AgentCapabilities } from 'tezgpt-data-provider';
import { QueryClient, QueryClientProvider } from '@tanstack/react-query';
import type { VerifyToolAuthResponse } from 'tezgpt-data-provider';
...
jest.mock('tezgpt-data-provider/react-query', () => ({
  useUpdateUserPluginsMutation: () => ({ mutate: jest.fn() }),
}));

jest.mock('@tezgpt/client', () => ({ useToastContext: () => ({ showToast: jest.fn() }) }));
jest.mock('~/hooks', () => ({
