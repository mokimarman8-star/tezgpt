...
import { Spinner, Button, SecretInput, Alert } from '@tezgpt/client';
import { useResetPasswordMutation } from 'tezgpt-data-provider/react-query';
import type { TResetPassword } from 'tezgpt-data-provider';
