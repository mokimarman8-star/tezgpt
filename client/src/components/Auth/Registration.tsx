...
import { useRegisterUserMutation } from 'tezgpt-data-provider/react-query';
import { ThemeContext, SecretInput, Spinner, Button, Input, isDark } from '@tezgpt/client';
import type { TRegisterUser, TError } from 'tezgpt-data-provider';
