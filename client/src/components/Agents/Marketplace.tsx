...
import { useMediaQuery } from '@tezgpt/client';
import { PermissionTypes, Permissions } from 'tezgpt-data-provider';
...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  // Set page title
  useDocumentTitle(`${localize('com_agents_marketplace')} | TezGPT`);
