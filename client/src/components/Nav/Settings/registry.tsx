import { SettingsTabValues } from 'tezgpt-data-provider';
...
import ByokPanel from '../SettingsTabs/Byok/ByokPanel';
...
const { GENERAL, CHAT, SPEECH, DATA, ACCOUNT, ABOUT, BYOK } = SettingsTabValues;
...
export const registry: SettingEntry[] = [
  ...
  // TezGPT BYOK — local encrypted keys
  {
    id: 'byokPanel',
    tab: BYOK,
    section: 'byok',
    labelKey: 'com_ui_settings_tab_byok',
    keywords: ['key', 'api', 'token', 'byok', 'anthropic', 'openai', 'openrouter', 'github'],
    Component: ByokPanel,
  },
