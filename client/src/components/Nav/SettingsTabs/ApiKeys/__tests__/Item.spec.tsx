...
import { useDeleteAgentApiKeyMutation } from 'tezgpt-data-provider/react-query';
import type { TAgentApiKeyListItem } from 'tezgpt-data-provider';
import { render, fireEvent } from 'test/layout-test-utils';
import Item from '../Item';

jest.mock('tezgpt-data-provider/react-query', () => ({
  ...jest.requireActual('tezgpt-data-provider/react-query'),
