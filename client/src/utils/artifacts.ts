...
import { excelMimeTypes, shadcnComponents } from 'tezgpt-data-provider';
import type {
  SandpackProviderProps,
  SandpackPredefinedTemplate,
} from '@codesandbox/sandpack-react';
import type { TStartupConfig, TAttachment, TFile } from 'tezgpt-data-provider';
...
const artifactFilename = {
  ...
  'application/vnd.tezgpt.docx-preview': 'index.html',
  'application/vnd.tezgpt.spreadsheet-preview': 'index.html',
  'application/vnd.tezgpt.presentation-preview': 'index.html',
...
> = {
  ...
  'application/vnd.tezgpt.docx-preview': 'static',
  'application/vnd.tezgpt.spreadsheet-preview': 'static',
  'application/vnd.tezgpt.presentation-preview': 'static',
  default: 'static',
  // 'css': 'css',
  // 'javascript': 'js',
  // 'typescript': 'ts',
...
> = {
  ...
  'application/vnd.tezgpt.docx-preview': {},
  'application/vnd.tezgpt.spreadsheet-preview': {},
  'application/vnd.tezgpt.presentation-preview': {},
...
export const TOOL_ARTIFACT_TYPES = {
   ...
   * `index.html` slot. The values are synthetic TezGPT-internal MIMEs
  ...
  DOCX: 'application/vnd.tezgpt.docx-preview',
  SPREADSHEET: 'application/vnd.tezgpt.spreadsheet-preview',
  PRESENTATION: 'application/vnd.tezgpt.presentation-preview',
} as const;
