...
const { FileSources } = require('tezgpt-data-provider');
const { findUser } = require('~/models');
const { resolveAppConfigForUser } = require('@tezgpt/api');
...
-----END CERTIFICATE-----
  ...
  it('should block login when email exists with different provider', async () => {
    ...
    expect(result.details.message).toBe(require('tezgpt-data-provider').ErrorTypes.AUTH_FAILED);
  });
