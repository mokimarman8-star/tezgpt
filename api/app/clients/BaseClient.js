...
class BaseClient {
  constructor(apiKey, options = {}) {
    ...
    /** @type {import('tezgpt-data-provider').VisionModes | undefined} */
    this.visionMode;
    /** @type {import('tezgpt-data-provider').FileConfig | undefined} */
    this._mergedFileConfig;
    /** @type {import('tezgpt-data-provider').EndpointFileConfig | undefined} */
