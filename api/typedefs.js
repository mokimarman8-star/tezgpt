 ...
 * @typedef {import('tezgpt-data-provider').Agents.ToolCallDelta} AgentToolCallDelta
 * @memberof typedefs
 */

/**
 * @exports ToolCallChunk
 * @typedef {import('tezgpt-data-provider').Agents.ToolCallChunk} ToolCallChunk
 * @memberof typedefs
 */

/**
 * @exports MessageContentImageUrl
 * @typedef {import('tezgpt-data-provider').Agents.MessageContentImageUrl} MessageContentImageUrl
 * @memberof typedefs
 */
...
/**
 * @exports ValidSource
 * @typedef {import('tezgpt-data-provider').ValidSource} ValidSource
 * @memberof typedefs
 */
...
/**
 * @exports TPrompt
 * @typedef {import('tezgpt-data-provider').TPrompt} TPrompt
 * @memberof typedefs
 */

/**
 * @exports TPromptGroup
 * @typedef {import('tezgpt-data-provider').TPromptGroup} TPromptGroup
 * @memberof typedefs
 */

/**
 * @exports TCreatePrompt
 * @typedef {import('tezgpt-data-provider').TCreatePrompt} TCreatePrompt
 * @memberof typedefs
 */

/**
 * @exports TCreatePromptRecord
 * @typedef {import('tezgpt-data-provider').TCreatePromptRecord} TCreatePromptRecord
 * @memberof typedefs
 */
/**
 * @exports TCreatePromptResponse
 * @typedef {import('tezgpt-data-provider').TCreatePromptResponse} TCreatePromptResponse
 * @memberof typedefs
 */
/**
 * @exports TUpdatePromptGroupResponse
 * @typedef {import('tezgpt-data-provider').TUpdatePromptGroupResponse} TUpdatePromptGroupResponse
 * @memberof typedefs
 */

/**
 * @exports TPromptGroupsWithFilterRequest
 * @typedef {import('tezgpt-data-provider').TPromptGroupsWithFilterRequest } TPromptGroupsWithFilterRequest
 * @memberof typedefs
 */

/**
 * @exports PromptGroupListResponse
 * @typedef {import('tezgpt-data-provider').PromptGroupListResponse } PromptGroupListResponse
 * @memberof typedefs
 */

/**
 * @exports TGetCategoriesResponse
 * @typedef {import('tezgpt-data-provider').TGetCategoriesResponse } TGetCategoriesResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsResponse
 * @typedef {import('tezgpt-data-provider').TGetRandomPromptsResponse } TGetRandomPromptsResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsRequest
 * @typedef {import('tezgpt-data-provider').TGetRandomPromptsRequest } TGetRandomPromptsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdatePromptGroupPayload
 * @typedef {import('tezgpt-data-provider').TUpdatePromptGroupPayload } TUpdatePromptGroupPayload
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptVariables
 * @typedef {import('tezgpt-data-provider').TDeletePromptVariables } TDeletePromptVariables
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptResponse
 * @typedef {import('tezgpt-data-provider').TDeletePromptResponse } TDeletePromptResponse
 * @memberof typedefs
 */
...
/**
 * @exports TRole
 * @typedef {import('tezgpt-data-provider').TRole } TRole
 * @memberof typedefs
 */

/**
 * @exports PermissionTypes
 * @typedef {import('tezgpt-data-provider').PermissionTypes } PermissionTypes
 * @memberof typedefs
 */

/**
 * @exports Permissions
 * @typedef {import('tezgpt-data-provider').Permissions } Permissions
 * @memberof typedefs
 */
...
/**
 * @exports Assistant
 * @typedef {import('tezgpt-data-provider').Assistant} Assistant
 * @memberof typedefs
 */

/**
 * @exports AssistantDocument
 * @typedef {import('tezgpt-data-provider').AssistantDocument} AssistantDocument
 * @memberof typedefs
 */

/**
 * @exports OpenAIFile
 * @typedef {import('tezgpt-data-provider').File} OpenAIFile
 * @memberof typedefs
 */

/**
 * @exports TConfig
 * @typedef {import('tezgpt-data-provider').TConfig} TConfig
 * @memberof typedefs
 */

/**
 * @exports TPayload
 * @typedef {import('tezgpt-data-provider').TPayload} TPayload
 * @memberof typedefs
 */

/**
 * @exports TAzureModelConfig
 * @typedef {import('tezgpt-data-provider').TAzureModelConfig} TAzureModelConfig
 * @memberof typedefs
 */

/**
 * @exports TAzureGroup
 * @typedef {import('tezgpt-data-provider').TAzureGroup} TAzureGroup
 * @memberof typedefs
 */

/**
 * @exports TAzureGroups
 * @typedef {import('tezgpt-data-provider').TAzureGroups} TAzureGroups
 * @memberof typedefs
 */

/**
 * @exports TAzureModelGroupMap
 * @typedef {import('tezgpt-data-provider').TAzureModelGroupMap} TAzureModelGroupMap
 * @memberof typedefs
 */
/**
 * @exports TAzureGroupMap
 * @typedef {import('tezgpt-data-provider').TAzureGroupMap} TAzureGroupMap
 * @memberof typedefs
 */

/**
 * @exports TAzureConfig
 * @typedef {import('tezgpt-data-provider').TAzureConfig} TAzureConfig
 * @memberof typedefs
 */

/**
 * @exports TModelsConfig
 * @typedef {import('tezgpt-data-provider').TModelsConfig} TModelsConfig
 * @memberof typedefs
 */

/**
 * @exports TStartupConfig
 * @typedef {import('tezgpt-data-provider').TStartupConfig} TStartupConfig
 * @memberof typedefs
 */

/**
 * @exports TConfigDefaults
 * @typedef {import('tezgpt-data-provider').TConfigDefaults} TConfigDefaults
 * @memberof typedefs
 */

/**
 * @exports TPlugin
 * @typedef {import('tezgpt-data-provider').TPlugin} TPlugin
 * @memberof typedefs
 */

/**
 * @exports TAzureConfigValidationResult
 * @typedef {import('tezgpt-data-provider').TAzureConfigValidationResult} TAzureConfigValidationResult
 * @memberof typedefs
 */

/**
 * @exports EImageOutputType
 * @typedef {import('tezgpt-data-provider').EImageOutputType} EImageOutputType
 * @memberof typedefs
 */

/**
 * @exports TCustomConfig
 * @typedef {import('tezgpt-data-provider').TCustomConfig} TCustomConfig
 * @memberof typedefs
 */

/**
 * @exports TProviderSchema
 * @typedef {import('tezgpt-data-provider').TProviderSchema} TProviderSchema
 * @memberof typedefs
 */

/**
 * @exports TBaseEndpoint
 * @typedef {import('tezgpt-data-provider').TBaseEndpoint} TBaseEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpoint
 * @typedef {import('tezgpt-data-provider').TEndpoint} TEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointsConfig
 * @typedef {import('tezgpt-data-provider').TEndpointsConfig} TEndpointsConfig
 * @memberof typedefs
 */

/**
 * @exports TMessage
 * @typedef {import('tezgpt-data-provider').TMessage} TMessage
 * @memberof typedefs
 */

/**
 * @exports TConversation
 * @typedef {import('tezgpt-data-provider').TConversation} TConversation
 * @memberof typedefs
 */

/**
 * @exports TModelSpec
 * @typedef {import('tezgpt-data-provider').TModelSpec} TModelSpec
 * @memberof typedefs
 */
...
/**
 * @exports FileSources
 * @typedef {import('tezgpt-data-provider').FileSources} FileSources
 * @memberof typedefs
 */
...
/**
 * @exports ImageFile
 * @typedef {import('tezgpt-data-provider').ImageFile} ImageFile
 * @memberof typedefs
 */

/**
 * @exports TMessageContentParts
 * @typedef {import('tezgpt-data-provider').TMessageContentParts} TMessageContentParts
 * @memberof typedefs
 */

/**
 * @exports StreamContentData
 * @typedef {import('tezgpt-data-provider').StreamContentData} StreamContentData
 * @memberof typedefs
 */

/**
 * @exports ActionRequest
 * @typedef {import('tezgpt-data-provider').ActionRequest} ActionRequest
 * @memberof typedefs
 */

/**
 * @exports Action
 * @typedef {import('tezgpt-data-provider').Action} Action
 * @memberof typedefs
 */

/**
 * @exports ActionMetadata
 * @typedef {import('tezgpt-data-provider').ActionMetadata} ActionMetadata
 * @memberof typedefs
 */

/**
 * @exports ActionAuth
 * @typedef {import('tezgpt-data-provider').ActionAuth} ActionAuth
 * @memberof typedefs
 */

/**
 * @exports DeleteFilesBody
 * @typedef {import('tezgpt-data-provider').DeleteFilesBody} DeleteFilesBody
 * @memberof typedefs
 */
...
/**
 * @exports MongoFile
 * @typedef {import('@tezgpt/data-schemas').IMongoFile} MongoFile
 * @memberof typedefs
 */

/**
 * @exports ISession
 * @typedef {import('@tezgpt/data-schemas').ISession} ISession
 * @memberof typedefs
 */

/**
 * @exports IBalance
 * @typedef {import('@tezgpt/data-schemas').IBalance} IBalance
 * @memberof typedefs
 */

/**
 * @exports IUser
 * @typedef {import('@tezgpt/data-schemas').IUser} IUser
 * @memberof typedefs
 */

/**
 * @exports IPluginAuth
 * @typedef {import('@tezgpt/data-schemas').IPluginAuth} IPluginAuth
 * @memberof typedefs
 */

/**
 * @exports IRole
 * @typedef {import('@tezgpt/data-schemas').IRole} IRole
 * @memberof typedefs
 */
 ...
 * @typedef {import('tezgpt-data-provider').EModelEndpoint} EModelEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointOption
 * @typedef {import('tezgpt-data-provider').TEndpointOption} TEndpointOption
 * @memberof typedefs
 */

/**
 * @exports TAttachment
 * @typedef {import('tezgpt-data-provider').TAttachment} TAttachment
 * @memberof typedefs
 */

/**
 * @exports AssistantCreateParams
 * @typedef {import('tezgpt-data-provider').AssistantCreateParams} AssistantCreateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantUpdateParams
 * @typedef {import('tezgpt-data-provider').AssistantUpdateParams} AssistantUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListParams
 * @typedef {import('tezgpt-data-provider').AssistantListParams} AssistantListParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListResponse
 * @typedef {import('tezgpt-data-provider').AssistantListResponse} AssistantListResponse
 * @memberof typedefs
 */

/**
 * @exports ContentPart
 * @typedef {import('tezgpt-data-provider').ContentPart} ContentPart
 * @memberof typedefs
 */

/**
 * @exports StepTypes
 * @typedef {import('tezgpt-data-provider').StepTypes} StepTypes
 * @memberof typedefs
 */

/**
 * @exports TContentData
 * @typedef {import('tezgpt-data-provider').TContentData} TContentData
 * @memberof typedefs
 */
 ...
 * @typedef {import('tezgpt-data-provider').PartMetadata} PartMetadata
 * @memberof typedefs
 */
 ...
 * @typedef {import('tezgpt-data-provider').TAssistantEndpoint} TAssistantEndpoint
 * @memberof typedefs
 */

/**
 * @exports TAgentsEndpoint
 * @typedef {import('tezgpt-data-provider').TAgentsEndpoint} TAgentsEndpoint
 * @memberof typedefs
 */

/**
 * @exports Agent
 * @typedef {import('tezgpt-data-provider').Agent} Agent
 * @memberof typedefs
 */

/**
 * @exports TEphemeralAgent
 * @typedef {import('tezgpt-data-provider').TEphemeralAgent} TEphemeralAgent
 * @memberof typedefs
 */

/**
 * @exports TWebSearchKeys
 * @typedef {import('@tezgpt/data-schemas').TWebSearchKeys} TWebSearchKeys
 * @memberof typedefs
 */

/**
 * @exports AgentToolResources
 * @typedef {import('tezgpt-data-provider').AgentToolResources} AgentToolResources
 * @memberof typedefs
 */

/**
 * @exports AgentCreateParams
 * @typedef {import('tezgpt-data-provider').AgentCreateParams} AgentCreateParams
 * @memberof typedefs
 */

/**
 * @exports AgentUpdateParams
 * @typedef {import('tezgpt-data-provider').AgentUpdateParams} AgentUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AgentListParams
 * @typedef {import('tezgpt-data-provider').AgentListParams} AgentListParams
 * @memberof typedefs
 */

/**
 * @exports AgentListResponse
 * @typedef {import('tezgpt-data-provider').AgentListResponse} AgentListResponse
 * @memberof typedefs
 */
 ...
 * @typedef {import('tezgpt-data-provider').TUpdateResourcePermissionsRequest} TUpdateResourcePermissionsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdateResourcePermissionsResponse
 * @typedef {import('tezgpt-data-provider').TUpdateResourcePermissionsResponse} TUpdateResourcePermissionsResponse
 * @memberof typedefs
 */

/**
 * @exports AppConfig
 * @typedef {import('@tezgpt/data-schemas').AppConfig} AppConfig
 * @memberof typedefs
 */

/**
 * @exports JsonSchemaType
 * @typedef {import('@tezgpt/data-schemas').JsonSchemaType} JsonSchemaType
 * @memberof typedefs
 */

/**
 * @exports MCPServers
 * @typedef {import('@tezgpt/api').MCPServers} MCPServers
 * @memberof typedefs
 */
...
/**
 * @exports MCPManager
 * @typedef {import('@tezgpt/api').MCPManager} MCPManager
 * @memberof typedefs
 */

/**
 * @exports MCPConnection
 * @typedef {import('@tezgpt/api').MCPConnection} MCPConnection
 * @memberof typedefs
 */

/**
 * @exports LCFunctionTool
 * @typedef {import('@tezgpt/api').LCFunctionTool} LCFunctionTool
 * @memberof typedefs
 */

/**
 * @exports FlowStateManager
 * @typedef {import('@tezgpt/api').FlowStateManager} FlowStateManager
 * @memberof typedefs
 */

/**
 * @exports LCAvailableTools
 * @typedef {import('@tezgpt/api').LCAvailableTools} LCAvailableTools
 * @memberof typedefs
 */

/**
 * @exports LCTool
 * @typedef {import('@tezgpt/api').LCTool} LCTool
 * @memberof typedefs
 */

/**
 * @exports FormattedContent
 * @typedef {import('@tezgpt/api').FormattedContent} FormattedContent
 * @memberof typedefs
 */
 ...
 * @property {import('@tezgpt/api').AgentStartupTelemetry} [startupTelemetry] - Startup latency recorder
 ...
 * @typedef {import('@tezgpt/data-schemas').FunctionTool} FunctionTool
 * @memberof typedefs
 */
 ...
 * @property {string} messageId - The ID of the message (from TezGPT).
 ...
 * @typedef {import('tezgpt-data-provider').TForkConvoResponse} TForkConvoResponse
 * @memberof typedefs
 */

/**
 * @exports TForkConvoRequest
 * @typedef {import('tezgpt-data-provider').TForkConvoRequest} TForkConvoRequest
 * @memberof typedefs
 */
