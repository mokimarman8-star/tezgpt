...
const { logger, CLIENT_MESSAGE_SELECT } = require('@tezgpt/data-schemas');
const {
  ContentTypes,
  feedbackSchema,
...
router.post('/branch', async (req, res) => {
  try {
    ...
    /** @type {Array<import('tezgpt-data-provider').TMessageContentParts>} */
    ...
    /** @type {import('tezgpt-data-provider').TMessage} */
    const newMessage = {
