...
jest.mock('@tezgpt/api', () => require(MOCKS).api());
jest.mock('@tezgpt/data-schemas', () => require(MOCKS).dataSchemas());
jest.mock('tezgpt-data-provider', () => require(MOCKS).dataProvider());
