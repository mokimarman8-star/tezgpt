 ...
 * @param {Record<string, import('@tezgpt/api').LCAvailableTools>} [params.config.mcpAvailableTools]
 * @param {import('@tezgpt/api').RequestScopedMCPConnectionStore} [params.config.requestScopedConnections]
 * @returns {object}
 */
...
const skillToolDeps = {
   ...
   * `TEZGPT_CODE_BASEURL` and the sandbox session id is forwarded by
