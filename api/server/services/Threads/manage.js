...
const { countTokens } = require('@tezgpt/api');
const { escapeRegExp } = require('@tezgpt/data-schemas');
const {
  Constants,
  ContentTypes,
  AnnotationTypes,
 ...
 * @param {import('tezgpt-data-provider').TFile[]} [params.files] - Optional. List of Attached File Objects.
...
/**
 * Records TezGPT messageId to all response messages' metadata
 *
 * @param {Object} params - The parameters for initializing a thread.
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.messageId - The response `messageId` generated by TezGPT.
...
/**
 * Synchronizes TezGPT messages to Thread Messages.
 * Updates the TezGPT DB with any missing Thread Messages and
 ...
 * @param {TMessage[]} params.dbMessages - The TezGPT DB messages.
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {string} params.endpoint - The current endpoint.
 * @param {string} [params.latestMessageId] - Optional: The latest message ID from TezGPT.
 * @param {string} params.thread_id - Response thread ID.
 * @param {string} params.run_id - Response Run ID.
 * @param {string} params.conversationId - TezGPT conversation ID.
 * @return {Promise<TMessage[]>} A promise that resolves to the updated messages
 */
 ...
 * @param {OpenAIClient} params.openai - The OpenAI client instance.
 * @param {RunClient} params.client - The TezGPT client that manages the run: either refers to `OpenAI` or `StreamRunManager`.
