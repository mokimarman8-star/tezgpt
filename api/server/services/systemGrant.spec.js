...
const { createModels, createMethods } = require('@tezgpt/data-schemas');
const { MongoMemoryServer } = require('mongodb-memory-server');
const { SystemRoles, PrincipalType } = require('tezgpt-data-provider');
const { SystemCapabilities } = require('@tezgpt/data-schemas');

jest.mock('@tezgpt/data-schemas', () => ({
  ...jest.requireActual('@tezgpt/data-schemas'),
  getTransactionSupport: jest.fn().mockResolvedValue(false),
  createModels: jest.requireActual('@tezgpt/data-schemas').createModels,
  createMethods: jest.requireActual('@tezgpt/data-schemas').createMethods,
}));
