...
const { logger, runAsSystem } = require('@tezgpt/data-schemas');
const {
  sanitizeFilename,
  parseText,
  processAudioFile,
 ...
 * @param {import('@tezgpt/api').UploadSseStream | null} [params.sseStream] - Active upload SSE stream, if enabled.
 ...
 * @param {RunClient} params.client - The TezGPT client instance: either refers to `openai` or `streamRunManager`.
 * @param {string} params.file_id - The ID of the file to retrieve.
