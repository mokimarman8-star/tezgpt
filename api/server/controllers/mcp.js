 ...
 * Handles MCP-specific tool endpoints, decoupled from regular TezGPT tools
 *
 * @import { MCPServerRegistry } from '@tezgpt/api'
 * @import { MCPServerDocument } from 'tezgpt-data-provider'
 */
const { randomUUID } = require('crypto');
const { logger, SystemCapabilities } = require('@tezgpt/data-schemas');
const {
  checkAccess,
  isUserSourced,
  MCPConnection,
