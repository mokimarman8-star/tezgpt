/**
 * @import { TUpdateResourcePermissionsRequest, TUpdateResourcePermissionsResponse } from 'tezgpt-data-provider'
 */

const mongoose = require('mongoose');
const { logger, getTenantId, SYSTEM_TENANT_ID } = require('@tezgpt/data-schemas');
const { ResourceType, PrincipalType, PermissionBits } = require('tezgpt-data-provider');
const { enrichRemoteAgentPrincipals, backfillRemoteAgentPermissions } = require('@tezgpt/api');
const {
