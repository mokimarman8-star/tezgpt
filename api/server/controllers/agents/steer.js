...
const { logger, ResourceCapabilityMap } = require('@tezgpt/data-schemas');
const {
  Permissions,
  ResourceType,
  PermissionBits,
 ...
 * @returns {(run: import('@tezgpt/api').SteerRunContext) => Promise<boolean>}
 */
 ...
 * resolve, status-guarded enqueue) lives in `@tezgpt/api`
