...
const {
  ...
  TEZGPT_CHECKPOINT_NAMESPACE_KEY,
...
class AgentClient extends BaseClient {
  constructor(options = {}) {
     ...
     *  @type {{ latest: import('tezgpt-data-provider').TContextUsageEvent | null } | undefined} */
     ...
     *  @type {Array<import('tezgpt-data-provider').TTokenUsageEvent> | undefined} */
     ...
     *  @type {Map<string, import('@tezgpt/api').ToolInputValidationError> | undefined} */
     ...
     *  @type {import('@tezgpt/api').SteerOffsetState} */
   ...
   * @param {import('@tezgpt/api').SteerQueueItem} item
   */
  ...
  buildActivityLabelWiring(streamId, abortSignal) {
    ...
    /** Per-endpoint opt-in via `activityLabel: true` in tezgpt.yaml,
  ...
  async useMemory() {
    ...
    /** @type {import('@tezgpt/api').MemoryConfig} */
    const config = {
   ...
   *   contextUsage?: import('tezgpt-data-provider').TContextUsageEvent,
   *   usage?: import('tezgpt-data-provider').TResponseUsage,
   * } | undefined}
   */
   ...
   * @returns {import('@tezgpt/api').EndpointTokenConfig | undefined}
   */
   ...
   *
   * @param {Array<import('tezgpt-data-provider').ContentPart | null | undefined>} previousParts
   */
    ...
    try {
      ...
      config = {
        ...
        configurable: {
          ...
          checkpoint_ns: '',
          [TEZGPT_CHECKPOINT_NAMESPACE_KEY]: this.checkpointNamespace,
   ...
   * @param {import('@tezgpt/api').ActivityPhaseSnapshot} [params.activityPhaseSnapshot]
   * @param {AbortController} [params.abortController]
