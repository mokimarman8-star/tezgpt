...
const { agentSchema, aclEntrySchema, fileSchema, userSchema } = require('@tezgpt/data-schemas');
const {
  Tools,
  FileSources,
  PermissionBits,
...
const { mergeDeploymentSkillIds, refreshS3Url } = require('@tezgpt/api');

/**
 * @type {import('mongoose').Model<import('@tezgpt/data-schemas').IAgent>}
 */
let Agent;
let AclEntry;
let User;
