...
This directory contains comprehensive Redis configuration files and scripts for TezGPT development and testing, supporting both cluster and single-node setups with optional TLS encryption.
...
REDIS_CA=/path/to/TezGPT/redis-config/certs/ca-cert.pem
```
...
ls -la /path/to/TezGPT/redis-config/certs/ca-cert.pem

# Test TezGPT Redis configuration
cd /path/to/TezGPT
npm run backend
...
For TezGPT integration:
- [TezGPT Documentation](https://github.com/tezgpt-ai/TezGPT)