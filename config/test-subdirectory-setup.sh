...
NGINX_CONF="/tmp/tezgpt-subdir-test-nginx.conf"
NGINX_PID="/tmp/tezgpt-subdir-test-nginx.pid"
...
worker_processes 1;
pid /tmp/tezgpt-subdir-test-nginx.pid;
error_log /tmp/tezgpt-subdir-test-nginx-error.log warn;
...
http {
    access_log /tmp/tezgpt-subdir-test-nginx-access.log;
...
start() {
    ...
    echo ""
    echo "=== Logs ==="
    echo "  Access: /tmp/tezgpt-subdir-test-nginx-access.log"
    echo "  Error:  /tmp/tezgpt-subdir-test-nginx-error.log"
    echo ""
...
stop() {
    ...
    rm -f "$NGINX_CONF" /tmp/tezgpt-subdir-test-nginx-*.log
