...
const targets = [
  ...
  {
    name: 'tezgpt-data-provider',
    dir: 'packages/data-provider',
    entries: ['src/index.ts', 'src/react-query/index.ts'],
    alias: { 'tezgpt-data-provider/react-query': 'src/react-query/index.ts', src: 'src' },
    internal: ['src/', 'tezgpt-data-provider/react-query'],
    minModules: 20,
    /**
