...
const { getBalanceConfig } = require('@tezgpt/api');
const { User, Balance } = require('@tezgpt/data-schemas').createModels(mongoose);
...
(async () => {
  ...
  if (!balanceConfig?.enabled) {
    console.red('Error: Balance is not enabled. Use tezgpt.yaml to enable it');
    silentExit(1);
  }
