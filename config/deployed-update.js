...
(async () => {
  ...
  console.purple('Removing all tags for TezGPT `deployed` images...');
  const repositories = ['ghcr.io/tezgpt-ai/tezgpt-ai/tezgpt-dev-api', 'tezgpt-client'];
  ...
  console.purple('Pulling latest TezGPT images...');
