...
const { runAsSystem } = require('@tezgpt/data-schemas');
const { User } = require('@tezgpt/data-schemas').createModels(mongoose);
const { countUsers } = require('@tezgpt/data-schemas').createMethods(mongoose);
