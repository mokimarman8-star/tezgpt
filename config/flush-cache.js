...
/**
 * TezGPT Cache Flush Utility
 *
 * This script flushes the cache store used by TezGPT, whether it's
...
DESCRIPTION:
  Flushes the cache store used by TezGPT. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the TezGPT backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 TezGPT Cache Flush Utility');
  console.log('================================');
