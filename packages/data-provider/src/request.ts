...
const AUTH_REDIRECT_STORAGE_KEY = 'tezgpt.auth.redirect.startedAt';
...
type AuthRecoveryWindow = Window & {
  __tezgptAuthRecovery?: AuthRecoveryState;
};
...
const getAuthRecoveryState = (): AuthRecoveryState => {
  ...
  browserWindow.__tezgptAuthRecovery ??= {
    lastRedirectStartedAt: 0,
    refreshPromise: null,
  };
  return browserWindow.__tezgptAuthRecovery;
};
