...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'tezgpt-westus'
    expect(groupMap).toHaveProperty('tezgpt-westus');
    expect(groupMap['tezgpt-westus']).toEqual(
    ...
    // Check groupMap for 'tezgpt-eastus'
    expect(groupMap).toHaveProperty('tezgpt-eastus');
    expect(groupMap['tezgpt-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'tezgpt-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'tezgpt-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'tezgpt-eastus',
