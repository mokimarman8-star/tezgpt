import type { TConversation, TEndpointOption } from 'tezgpt-data-provider';
import type { IUser, AppConfig } from '@tezgpt/data-schemas';
import type { Request } from 'express';

/**
 * TezGPT-specific request body type that extends Express Request body
