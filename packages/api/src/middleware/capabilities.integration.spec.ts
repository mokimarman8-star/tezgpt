...
import { PrincipalType, SystemRoles } from 'tezgpt-data-provider';
import {
  createModels,
  createMethods,
  SystemCapabilities,
...
import type { SystemCapability, ConfigSection } from '@tezgpt/data-schemas';
import type { AllMethods } from '@tezgpt/data-schemas';
import {
