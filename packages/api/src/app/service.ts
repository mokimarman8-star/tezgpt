import { PrincipalType, materializeModelSpecEndpoints } from 'tezgpt-data-provider';
import {
  logger,
  getTenantId,
...
import type { AppConfig, IConfig } from '@tezgpt/data-schemas';
...
export interface AppConfigServiceDeps {
  ...
  /** The CacheKeys constants from tezgpt-data-provider. */
