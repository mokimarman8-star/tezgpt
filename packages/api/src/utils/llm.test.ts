import { extractTezGPTParams } from './llm';

describe('extractTezGPTParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractTezGPTParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractTezGPTParams();
  ...
  it('should extract all TezGPT params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractTezGPTParams(options);
  ...
  it('should handle null values for TezGPT params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known TezGPT params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractTezGPTParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional TezGPT params', () => {
    const options = {
      resendFiles: false,
