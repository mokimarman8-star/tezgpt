...
import { logger, tenantStorage } from '@tezgpt/data-schemas';
import {
  ResourceType,
  PrincipalType,
  AccessRoleIds,
...
import type { SkillSyncConfig, SkillSyncGitHubSourceConfig } from 'tezgpt-data-provider';
