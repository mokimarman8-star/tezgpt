...
export const credentialMetadataCollection = 'tezgptCredentialMetadata';

const credentialRuntimeKey = Symbol.for('tezgpt.credentials.runtime');
const tempCredentialPathEnvironment = 'TEZGPT_TEMP_CREDENTIALS_PATH';
...
function serializeCredentialFile(values: Partial<Record<CredentialName, string>>): string {
  return [
    '# Automatically generated by TezGPT. Keep this file private and persistent.',
