...
import { mbToBytes, isOpenAILikeProvider } from 'tezgpt-data-provider';
 ...
 * `global.anthropic.claude-*`), bare (`claude-*`, used when the TezGPT model
 ...
 * same PDF exemption.
 *
 * Mirrors `BEDROCK_CLAUDE_4PLUS_THINKING` in `tezgpt-data-provider`, which
