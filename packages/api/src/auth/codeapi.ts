import { getTenantId } from '@tezgpt/data-schemas';
...
type PrincipalSource = 'tezgpt_jwt' | 'openid_reuse';
...
function isManagedCodeApiJwtMode(): boolean {
  ...
  return provider === 'tezgpt-jwt' || provider === 'both';
}
