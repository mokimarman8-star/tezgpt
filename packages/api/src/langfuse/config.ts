...
type LangfuseRunConfigWithTraceAttributes = LangfuseRunConfig & {
  tezgptTraceAttributes?: Record<string, string | number | boolean | null | undefined>;
...
const TENANT_EXPORT_ATTRIBUTE = 'tezgpt.langfuse.tenant_export.enabled';
const TENANT_DESTINATION_ATTRIBUTE = 'tezgpt.langfuse.destination';
const CENTRAL_EXPORT_ATTRIBUTE = 'tezgpt.langfuse.central_export.enabled';
...
function disableCentralExport(langfuse: LangfuseRunConfigWithTraceAttributes): void {
  langfuse.tezgptTraceAttributes = {
    ...(langfuse.tezgptTraceAttributes ?? {}),
