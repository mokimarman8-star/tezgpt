import { webSearchAuth } from '@tezgpt/data-schemas';
import {
  AuthType,
  SafeSearchTypes,
  SearchCategories,
...
import type { RerankerTypes, TCustomConfig, TWebSearchConfig } from 'tezgpt-data-provider';
import type { TWebSearchKeys, TWebSearchCategories } from '@tezgpt/data-schemas';
