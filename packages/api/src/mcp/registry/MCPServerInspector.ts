...
import { Constants, normalizeServerName } from 'tezgpt-data-provider';
import type { JsonSchemaType } from '@tezgpt/data-schemas';
...
export class MCPServerInspector {
  ...
  /**
   * Converts server tools to TezGPT-compatible tool functions format, keeping the ordering
