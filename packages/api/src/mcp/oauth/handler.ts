...
import { TokenExchangeMethodEnum, type MCPOptions } from 'tezgpt-data-provider';
import {
...
import type { TokenMethods } from '@tezgpt/data-schemas';
import type {
...
export class MCPOAuthHandler {
   ...
   * {@link selectResourceURL}, a code path TezGPT does not go through.
   */
   ...
   * granted scope when it is omitted). TezGPT sends it by default because some
