...
import { SteerEvents } from 'tezgpt-data-provider';
import type { IMongoFile } from '@tezgpt/data-schemas';
import type { TFile } from 'tezgpt-data-provider';
import type {
 ...
 * TezGPT wrapper always supplies this field, so malformed/missing wire
 ...
 * behavior); the TezGPT route wires all three.
 */
