 ...
 *
 * Exercises the FULL TezGPT -> agents pipeline:
 *   TezGPT's createRun (@tezgpt/api)
...
(hasAnthropic ? describe : describe.skip)('Anthropic Summarization E2E (TezGPT)', () => {
...
(hasOpenAI ? describe : describe.skip)('OpenAI Summarization E2E (TezGPT)', () => {
  jest.setTimeout(180_000);
...
(hasBothProviders ? describe : describe.skip)(
  'Cross-provider Summarization E2E (TezGPT)',
  () => {
    jest.setTimeout(180_000);
