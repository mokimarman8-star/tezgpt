/**
 * OpenAI-compatible API for TezGPT agents.
 *
 * This module provides an OpenAI v1/chat/completions compatible interface
 * for interacting with TezGPT agents remotely via API.
 *
 * @example
 * ```typescript
 * import { createAgentChatCompletion, listAgentModels } from '@tezgpt/api';
 *
