 ...
 * and ephemeral request-scoped MCP tools (runtime `{{TEZGPT_BODY_*}}`
...
import { Tools, Constants, imageGenTools } from 'tezgpt-data-provider';
import type { LCTool, LCToolRegistry, JsonSchemaType } from '@librechat/agents';
import type { AgentToolOptions } from 'tezgpt-data-provider';
...
/** Poll tool name (TezGPT host-special-cased, not an SDK tool). */
