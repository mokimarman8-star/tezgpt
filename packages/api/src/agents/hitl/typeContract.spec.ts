...
import type { Agents } from 'tezgpt-data-provider';

/**
 * Compile-time contract between the SDK's HITL wire types and TezGPT's
 * `Agents.*` mirror in `tezgpt-data-provider`. The mirror is hand-maintained
 ...
 */
describe('HITL type contract: @librechat/agents ↔ tezgpt-data-provider', () => {
