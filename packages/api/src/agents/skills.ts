...
import { isEphemeralAgentId } from 'tezgpt-data-provider';
 ...
 * `@tezgpt/api` that import the manual-only splicer directly.
 */
 ...
 * authored against tools TezGPT hasn't implemented yet — the registry
