...
/* =============================================================================
 * TEZGPT EXTENSION EVENTS
 * Custom events prefixed with 'tezgpt:' per Open Responses spec
 * @see https://openresponses.org/specification#extending-streaming-events
 * ============================================================================= */

/**
 * Attachment data for tezgpt:attachment events
 */
...
/**
 * Emit tezgpt:attachment event for file/image attachments
 * This is a TezGPT extension to the Open Responses streaming protocol.
