...
import { Tools } from 'tezgpt-data-provider';
...
/**
 * Claude built-ins with no TezGPT runtime equivalent. A tool matcher naming
...
/**
 * Runs `command` hook handlers as child processes outside the TezGPT API
