...
import type { TEndpoint } from 'tezgpt-data-provider';
 ...
 * This function handles custom endpoints defined in tezgpt.yaml, including
...
export async function initializeCustom({
  ...
  if (
    ...
    await fetchModels({
      ...
      // templates like {{TEZGPT_OPENID_ID_TOKEN}} would otherwise resolve
