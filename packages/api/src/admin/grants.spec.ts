...
import { PrincipalType } from 'tezgpt-data-provider';
import { SystemCapabilities, expandImplications } from '@tezgpt/data-schemas';
import type { ISystemGrant } from '@tezgpt/data-schemas';
