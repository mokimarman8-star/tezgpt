...
export const darkTheme: IThemeRGB = {
  ...
  'rgb-link': '150 135 240', // #9687f0 (brand violet-light)
  'rgb-link-hover': '147 197 253', // #93c5fd (blue-300)
  'rgb-link-visited': '192 132 252', // #c084fc (purple-400)
  'rgb-accent-primary': '139 125 232', // #8b7de8
  'rgb-accent-primary-hover': '156 143 238', // #9c8fee
  ...
  'rgb-surface-submit': '224 138 90', // #e08a5a (brand rose-gold)
  'rgb-surface-submit-hover': '236 156 108', // #ec9c6c
