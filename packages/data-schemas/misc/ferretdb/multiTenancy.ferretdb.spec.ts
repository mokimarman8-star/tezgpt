 ...
 *
 * Validates whether FerretDB can handle TezGPT's multi-tenancy model
 ...
 *   PG_CONTAINER     — Docker container name for psql (default: tezgpt-ferretdb-postgres-1)
...
const PG_CONTAINER = process.env.PG_CONTAINER || 'tezgpt-ferretdb-postgres-1';
