import { ResourceType } from 'tezgpt-data-provider';
 ...
 *
 * These are used by the admin panel and TezGPT API to gate access to
...
/** Top-level keys of the configSchema from tezgpt.yaml. */
