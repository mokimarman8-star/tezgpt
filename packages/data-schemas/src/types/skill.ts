import type { CodeEnvRef, CodeEnvRefMap } from 'tezgpt-data-provider';
import type { Document, Types } from 'mongoose';

/**
 * Skill — the single source of truth for a TezGPT skill.
...
export interface ISkill {
  ...
  name: string;
  /**
   * Human-readable label shown only in the TezGPT UI (skill list, detail
