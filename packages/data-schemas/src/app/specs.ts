...
/**
 * Sets up Model Specs from the config (`tezgpt.yaml`) file.
...
For more information, see the documentation at https://www.tezgpt.app/docs/configuration/tezgpt_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
