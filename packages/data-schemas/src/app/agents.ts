import { EModelEndpoint, agentsEndpointSchema } from 'tezgpt-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'tezgpt-data-provider';

/**
 * Sets up the Agents configuration from the config (`tezgpt.yaml`) file.
