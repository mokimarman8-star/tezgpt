...
import type { CodeEnvRef } from 'tezgpt-data-provider';
...
/**
 * Slash-command names that collide with TezGPT / Claude Code CLI commands.
 ...
 * from Anthropic's Agent Skills spec plus the fields TezGPT needs to pass
...
export function createSkillMethods(
   ...
   * set), and TezGPT does not currently require that deployment shape. In
