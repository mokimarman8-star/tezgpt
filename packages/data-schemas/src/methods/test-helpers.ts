/**
 * Inlined utility functions previously imported from @tezgpt/api.
 ...
 *
 * Mirrors @tezgpt/api findMatchingPattern. Keep the two in step: this is the
 ...
 *
 * Inlined from @tezgpt/api matchModelName (simplified for test use)
 */
