#!/usr/bin/env node
/**
 * Sorts imports across the TezGPT monorepo per project convention
 ...
 * (`~/`, `src/`, `test/`). Workspace packages such as `tezgpt-data-provider`
 * and `@tezgpt/*` are treated as package imports, not local.
 *
