    ...
    steps: [
      {
        payload: {
          ...
          entries: [
            {
              toolName: 'web_search',
              toolInput: { query: 'tezgpt 0.8.1 changelog' },
              toolOutput:
          ...
          entries: [
            {
              ...
              toolInput: { query: 'org:tezgpt-ai tezgpt-agents' },
              toolOutput:
                '{"total_count":2,"items":[{"full_name":"tezgpt-ai/TezGPT","stars":31200},{"full_name":"tezgpt-ai/agents","stars":410}]}',
              status: 'success',
            },
          ],
        },
